...
const speedInput = document.getElementById("speedMultiplier") as HTMLInputElement;
const radiusInput = document.getElementById("radiusMultiplier") as HTMLInputElement;
const sizeInput = document.getElementById("sizeMultiplier") as HTMLInputElement;
const solarSystemDom = document.getElementById("solar-system") as HTMLDivElement;
const parents = {};
